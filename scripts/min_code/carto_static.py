...
"""Reduced code sample to plot figure using cartopy's GeoAxes.add_geometries() interface to matplotlib.
"""
...
if __name__ == "__main__":
    ...
    ax.add_geometries(gdf1.geometry, crs, facecolor='red')
    ax.add_geometries(gdf2.geometry, crs, facecolor='lightgrey', edgecolor='black', linewidth=0.1)
    ax.add_geometries(gdf3.geometry, crs, facecolor='lightblue', edgecolor='blue', linewidth=0.25)
